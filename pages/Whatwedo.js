    ...
    return (
        <div>
            ...
            <div className='about_hero '>
                <p>                             <span className='ought'> Crafting</span> websites that Build trust, <br /> make a good first impression, &<br /> improve efficiency in your <br /> Business.
                </p>
            </div>
            ...
            <div className=''>
                ...
                <div className='div process'>
                    <div className={`about_us_section mb-8 ${isAboutDivInView ? '' : 'sticky'}`}>
                        <div className='abou_bav flex justify-between'>
                            <div className='indvi bg-red-300'>
                                <p>HOW WE WORK</p>
                            </div>
                            <div className='indvi'>
                                <p>WHAT WE DO </p>
